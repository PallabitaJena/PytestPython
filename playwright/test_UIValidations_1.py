...
def test_childWindowHandle(page:Page):
    ...
    with page.expect_popup() as newPage_info:
        #step1
        #step2
        page.locator(".blinkingText", has_text="Free Access to InterviewQues").click()  # new page
        childPage = newPage_info.value
        text = childPage.locator(".red").text_content()
        print("The test we got :-> "+text) #Please email us at mentor@rahulshettyacademy.com with below template to receive response
